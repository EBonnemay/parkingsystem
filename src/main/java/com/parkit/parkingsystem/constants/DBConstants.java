...
public class DBConstants {
    ...
    public static final String GET_NUMBER_OF_TICKETS = "SELECT COUNT(*) FROM ticket WHERE VEHICLE_REG_NUMBER = ? AND in_time BETWEEN DATE_SUB(NOW(), INTERVAL 30 DAY) AND NOW()";
